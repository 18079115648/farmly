		...
		methods: {
			...
			oauthLogin() {
				...
				if (this.browserType === 1) {
					window.location.href = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=' + this.$store.state.wxAppId + '&redirect_uri=' + encodeURIComponent('http://192.168.0.32:820/testSkipPage') + '&response_type=code&scope=snsapi_userinfo&state=tcjp#wechat_redirect'
				} else {
